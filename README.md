...
- 工作台一级导航为「首页、待办事项、到期与提醒、Kindle、AI、X Assistant、设置」。AI 下提供完整提示词和短提示词维护，以及本机 Skills 目录浏览；提示词支持分类筛选、预览和复制，短提示词支持快速复制，Skills 支持按 agent 类型筛选、查看 SKILL.md 详情和保存备注。
