...
This repo uses a multi-context layout. Keep a root `CONTEXT-MAP.md` pointing at the relevant context files, with system-wide decisions in `docs/adr/` and context-specific decisions beside their source context:
