import { ChartBar, Database, CalendarEvent } from '@appica/icons-react';
...
import { StockEventsPage } from './StockEventsPage.jsx';
export const stockModule = {
  ...
  pages: {
    ...
    'stock-events': { name: '重要事件', path: '/stock/events', icon: CalendarEvent, Component: StockEventsPage },
    'stock-positions': { name: '仓位管理', path: '/stock/positions', icon: Database, Component: StockPositionsPage }
  }
};

export { StockStatsPage, StockPositionsPage, StockEntryPlansPage, StockMarketPage, StockEventsPage };
